...
var require_cursor = __commonJS({
  "node_modules/pdfjs/lib/cursor.js"(exports2, module) {
    "use strict";
    var Cursor = class {
...
var require_lexer = __commonJS({
  "node_modules/pdfjs/lib/parser/lexer.js"(exports2, module) {
    "use strict";
    var Lexer = class _Lexer {
      ...
      skipWhitespace(len, trial) {
        ...
        while (!done && (!len || count < len)) {
          ...
          if (_Lexer.isWhiteSpace(this.buf[this.pos])) {
            this.pos++;
            count++;
          } else {
            done = true;
      ...
      readNumber(trial) {
        ...
        switch (true) {
          ...
          case (c < 48 || c > 57):
            if (!trial) {
              this._error(
                "Invalid number at " + this.pos + ": " + String.fromCharCode(c) + " (code: " + c + ")"
              );
            }
            this.pos = before;
            return void 0;
...
var require_string = __commonJS({
  "node_modules/pdfjs/lib/object/string.js"(exports2, module) {
    "use strict";
    var Lexer = require_lexer();
    var PDFString = class _PDFString {
      constructor(str) {
        this.str = str;
      }
      toHexString() {
      ...
      static parse(xref, lexer, trial) {
        const literal = _PDFString.parseLiteral(lexer, trial);
        const hex = literal === void 0 && _PDFString.parseHex(lexer, trial);
        if (!literal && !hex) {
          if (trial) {
            return void 0;
          }
...
var require_ops = __commonJS({
  "node_modules/pdfjs/lib/ops.js"(exports2, module) {
    "use strict";
    ...
    module.exports = {
      ...
      toFixed(num, precision2) {
        return (+(Math.floor(+(num + "e" + precision2)) + "e" + -precision2)).toFixed(
          precision2
        );
      }
    };
...
var require_inftrees = __commonJS({
  "node_modules/pako/lib/zlib/inftrees.js"(exports2, module) {
    ...
    var inflate_table = (type, lens, lens_index, codes, table2, table_index, work, opts) => {
      ...
      offs2[1] = 0;
      for (len = 1; len < MAXBITS; len++) {
        offs2[len + 1] = offs2[len] + count[len];
      }
      for (sym = 0; sym < codes; sym++) {
...
var require_util = __commonJS({
  "node_modules/pdfjs/lib/util.js"(exports2) {
    "use strict";
    exports2.colorToRgb = function(hex) {
    ...
    exports2.rgbEqual = function(lhs, rhs) {
      return lhs && rhs && lhs[0] === rhs[0] && lhs[1] === rhs[1] && lhs[2] === rhs[2];
    };
    exports2.toArrayBuffer = function(b) {
    ...
    exports2.defaults = function(val, def) {
      return val !== void 0 ? val : def;
    };
    exports2.inflate = function(obj) {
...
var require_boolean = __commonJS({
  "node_modules/pdfjs/lib/object/boolean.js"(exports2) {
    exports2.parse = function(xref, lexer, trial) {
...
var require_null = __commonJS({
  "node_modules/pdfjs/lib/object/null.js"(exports2) {
    exports2.parse = function(xref, lexer, trial) {
...
var require_name = __commonJS({
  "node_modules/pdfjs/lib/object/name.js"(exports2, module) {
    "use strict";
    var PDFName = class _PDFName {
      constructor(name) {
        if (name === void 0 || name === null) {
          throw new Error("A Name cannot be undefined");
        }
        if (name instanceof _PDFName) {
          return name;
        }
        if (name[0] === "/") {
          name = name.substr(1);
...
var require_dictionary = __commonJS({
  "node_modules/pdfjs/lib/object/dictionary.js"(exports2, module) {
    "use strict";
    var PDFName = require_name();
    var PDFValue = require_value();
    var PDFDictionary = class _PDFDictionary {
...
var require_stream = __commonJS({
  "node_modules/pdfjs/lib/object/stream.js"(exports2, module) {
    "use strict";
...
var require_object = __commonJS({
  "node_modules/pdfjs/lib/object/object.js"(exports2, module) {
    "use strict";
    ...
    var PDFObject = class _PDFObject {
      ...
      static parse(xref, lexer, trial) {
        ...
        lexer.skipWhitespace(null, true);
        const obj = _PDFObject.parseInner(xref, lexer);
        lexer.skipWhitespace(null, true);
...
var require_reference = __commonJS({
  "node_modules/pdfjs/lib/object/reference.js"(exports2, module) {
    "use strict";
    var util = require_util();
    var PDFReference = class _PDFReference {
      constructor(obj) {
      ...
      static parse(xref, lexer, trial) {
        ...
        const ref = new _PDFReference(parseObject.bind(null, xref, lexer.outer, id));
...
var require_number = __commonJS({
  "node_modules/pdfjs/lib/object/number.js"(exports2) {
    exports2.parse = function(xref, lexer, trial) {
...
var require_value = __commonJS({
  "node_modules/pdfjs/lib/object/value.js"(exports2) {
    var Objects = [];
    exports2.parse = function(xref, lexer) {
      if (!Objects.length) {
...
var require_array = __commonJS({
  "node_modules/pdfjs/lib/object/array.js"(exports2, module) {
    "use strict";
    var PDFValue = require_value();
    var PDFArray = class _PDFArray {
      constructor(array) {
        if (!array) {
          array = [];
        }
...
var require_nametree = __commonJS({
  "node_modules/pdfjs/lib/object/nametree.js"(exports2, module) {
    "use strict";
    var PDFName = require_name();
    var PDFString = require_string();
    var PDFDictionary = require_dictionary();
...
var require_trailer = __commonJS({
  "node_modules/pdfjs/lib/object/trailer.js"(exports2, module) {
    "use strict";
    var PDFDictionary = require_dictionary();
    var PDFArray = require_array();
    var PDFString = require_string();
...
var require_xref = __commonJS({
  "node_modules/pdfjs/lib/object/xref.js"(exports2, module) {
    "use strict";
    var PDFObject = require_object();
    var util = require_util();
...
var require_object2 = __commonJS({
  "node_modules/pdfjs/lib/object/index.js"(exports2) {
    "use strict";
    exports2.PDFArray = exports2.Array = require_array();
    exports2.PDFDictionary = exports2.Dictionary = require_dictionary();
    exports2.PDFName = exports2.Name = require_name();
    exports2.PDFNameTree = exports2.NameTree = require_nametree();
    exports2.PDFObject = exports2.Object = require_object();
    exports2.PDFReference = exports2.Reference = require_reference();
    exports2.PDFStream = exports2.Stream = require_stream();
    exports2.PDFString = exports2.String = require_string();
    exports2.PDFTrailer = exports2.Trailer = require_trailer();
    exports2.PDFXref = exports2.Xref = require_xref();
  }
});

// node_modules/pdfjs/lib/parser/parser.js
var require_parser = __commonJS({
  "node_modules/pdfjs/lib/parser/parser.js"(exports2, module) {
    "use strict";
    var Lexer = require_lexer();
      ...
      static addObjectsRecursive(objects, value) {
        switch (true) {
          case value instanceof PDF.Reference:
            ...
            _Parser.addObjectsRecursive(objects, value.object);
            break;
          case value instanceof PDF.Object:
            _Parser.addObjectsRecursive(objects, value.properties);
            _Parser.addObjectsRecursive(objects, value.content);
            break;
          case value instanceof PDF.Dictionary:
            for (const key in value.dictionary) {
              ...
              _Parser.addObjectsRecursive(objects, value.dictionary[key]);
            }
            break;
          case Array.isArray(value):
            value.forEach(function(item) {
              _Parser.addObjectsRecursive(objects, item);
            });
            break;
        }
      }
...
var require_pdf = __commonJS({
  "node_modules/pdfjs/lib/image/pdf.js"(exports2, module) {
    "use strict";
    var PDF = require_object2();
    var Parser2 = require_parser();
    module.exports = class PDFImage {
      constructor(src) {
        const parser = new Parser2(src);
        parser.parse();
      ...
      async write(doc, xobjs) {
        ...
        for (let i = 0; i < this.xobjCount; ++i) {
          ...
          const objects = [];
          Parser2.addObjectsRecursive(objects, xobj);
...
var require_render = __commonJS({
  "node_modules/pdfjs/lib/image/render.js"(exports2, module) {
    "use strict";
    var ops = require_ops();
...
var require_jpeg = __commonJS({
  "node_modules/pdfjs/lib/image/jpeg.js"(exports2, module) {
    "use strict";
    var PDF = require_object2();
...
// node_modules/pdfjs/lib/errors/already-ended.js
var require_already_ended = __commonJS({
  "node_modules/pdfjs/lib/errors/already-ended.js"(exports2, module) {
...
var require_tiny_inflate = __commonJS({
  "node_modules/tiny-inflate/index.js"(exports2, module) {
    ...
    function tinf_build_bits_base2(bits, base, delta, first) {
      var i, sum;
      for (i = 0; i < delta; ++i)
        bits[i] = 0;
    ...
    function tinf_build_tree2(t, lengths3, off, num) {
      var i, sum;
      for (i = 0; i < 16; ++i)
        t.table[i] = 0;
      for (i = 0; i < num; ++i)
        t.table[lengths3[off + i]]++;
      t.table[0] = 0;
      ...
      for (i = 0; i < num; ++i) {
        if (lengths3[off + i])
          t.trans[offs2[lengths3[off + i]]++] = i;
      }
    }
    ...
    function tinf_decode_symbol2(d, t) {
      while (d.bitcount < 24) {
        d.tag |= d.source[d.sourceIndex++] << d.bitcount;
        d.bitcount += 8;
      }
    ...
    length_bits2[28] = 0;
    length_base2[28] = 258;
    module.exports = tinf_uncompress2;
  }
});
...
var require_classes = __commonJS({
  "node_modules/@rkusa/linebreak/src/classes.js"(exports2) {
    exports2.OP = 0;
    exports2.CL = 1;
    exports2.CP = 2;
    exports2.QU = 3;
...
var require_pairs = __commonJS({
  "node_modules/@rkusa/linebreak/src/pairs.js"(exports2) {
    var DI_BRK = exports2.DI_BRK = 0;
    var IN_BRK = exports2.IN_BRK = 1;
    var CI_BRK = exports2.CI_BRK = 2;
    var CP_BRK = exports2.CP_BRK = 3;
    var PR_BRK = exports2.PR_BRK = 4;
    exports2.pairTable = [
...
var require_classes2 = __commonJS({
  "node_modules/@rkusa/linebreak/src/classes.json"(exports2, module) {
...
var require_linebreaker = __commonJS({
  "node_modules/@rkusa/linebreak/src/linebreaker.js"(exports2, module) {
    "use strict";
...
var require_unorm = __commonJS({
  "node_modules/unorm/lib/unorm.js"(exports2, module) {
    (function(root) {
      "use strict";
...
var require_base = __commonJS({
  "node_modules/pdfjs/lib/font/base.js"(exports2, module) {
    ...
    Font2.StringWidth = StringWidth;
    module.exports = Font2;
  }
});

// node_modules/pdfjs/lib/text.js
var require_text = __commonJS({
  "node_modules/pdfjs/lib/text.js"(exports2, module) {
    "use strict";
    ...
    var ops = require_ops();
    var util = require_util();
    var Font2 = require_base();
    var PDF = require_object2();
    var UNDERLINE_FLAG = 1;
    var STRIKETHROUGH_FLAG = 2;
    var Text = module.exports = class Text extends Fragment {
      ...
      async _render(text, opts) {
        this._parts--;
        if (!Font2.isFont(opts.font || this.defaultFont)) {
...
var require_cell = __commonJS({
  "node_modules/pdfjs/lib/cell.js"(exports2, module) {
    "use strict";
    var Fragment = require_fragment();
    var util = require_util();
    var ops = require_ops();
...
var require_row = __commonJS({
  "node_modules/pdfjs/lib/row.js"(exports2, module) {
    "use strict";
    var Fragment = require_fragment();
    var util = require_util();
    var ops = require_ops();
...
var require_header = __commonJS({
  "node_modules/pdfjs/lib/header.js"(exports2, module) {
    "use strict";
    var Fragment = require_fragment();
    var util = require_util();
    var ops = require_ops();
...
var require_tableheader = __commonJS({
  "node_modules/pdfjs/lib/tableheader.js"(exports2, module) {
    "use strict";
    var PDF = require_object2();
    var Row = require_row();
    ...
    module.exports = class TableHeader extends Row {
      ...
      async _pageBreak() {
        throw new Error(
          "Table Header is to long (tried to execute a page break inside the header)"
        );
      }
      async _start() {
        this._startY = this._cursor.y;
...
var require_table = __commonJS({
  "node_modules/pdfjs/lib/table.js"(exports2, module) {
    "use strict";
    var Fragment = require_fragment();
    var util = require_util();
    var ops = require_ops();
    ...
    function applyOpts(opts) {
      ...
      if (opts.borderVerticalWidths) {
        ...
        if (opts.borderVerticalWidths.length !== this.widths.length + 1) {
          throw new TypeError(
            `wrong borderVerticalWidths length (expected ${this.widths.length + 1}; got ${opts.borderVerticalWidths.length})`
          );
        }
      ...
      if (opts.borderVerticalColors) {
        ...
        if (opts.borderVerticalColors.length !== this.widths.length + 1) {
          throw new TypeError(
            `wrong borderVerticalColors length (expected ${this.widths.length + 1}; got ${opts.borderVerticalColors.length})`
          );
        }
        this.borderVerticalColors = opts.borderVerticalColors.map(
          (c) => util.colorToRgb(c)
        );
...
var require_fragment = __commonJS({
  "node_modules/pdfjs/lib/fragment.js"(exports2, module) {
    "use strict";
    ...
    var AlreadyEndedError = require_already_ended();
    module.exports = class Fragment {
      ...
      table(opts) {
        ...
        const Table2 = require_table();
        const ctx = new Table2(this._doc, this, this._opts(opts));
        this._begin(ctx);
        return ctx;
      }
      image(img, opts) {
...
var require_events = __commonJS({
  "browser-external:events"(exports2, module) {
...
var require_util2 = __commonJS({
  "browser-external:util"(exports2, module) {
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
...
var require_buffer_list = __commonJS({
  "node_modules/readable-stream/lib/internal/streams/buffer_list.js"(exports2, module) {
    "use strict";
...
var require_errors_browser = __commonJS({
  "node_modules/readable-stream/errors-browser.js"(exports2, module) {
    "use strict";
...
var require_state = __commonJS({
  "node_modules/readable-stream/lib/internal/streams/state.js"(exports2, module) {
    "use strict";
...
var require_end_of_stream = __commonJS({
  "node_modules/readable-stream/lib/internal/streams/end-of-stream.js"(exports2, module) {
    "use strict";
...
var require_async_iterator = __commonJS({
  "node_modules/readable-stream/lib/internal/streams/async_iterator.js"(exports2, module) {
    "use strict";
...
var require_from_browser = __commonJS({
  "node_modules/readable-stream/lib/internal/streams/from-browser.js"(exports2, module) {
    module.exports = function() {
...
var require_pipeline = __commonJS({
  "node_modules/readable-stream/lib/internal/streams/pipeline.js"(exports2, module) {
    "use strict";
    var eos;
    function once(callback) {
      var called = false;
...
var require_content = __commonJS({
  "node_modules/pdfjs/lib/content.js"(exports2, module) {
    "use strict";
    var PDF = require_object2();
...
var require_external = __commonJS({
  "node_modules/pdfjs/lib/external.js"(exports2, module) {
    "use strict";
    var PDF = require_object2();
    var Parser2 = require_parser();
    var ops = require_ops();
    ...
    module.exports = class ExternalDocument {
      ...
      async write(doc, page) {
        ...
        for (const page2 of this._iterPagesRecursively(doc, kids, filter)) {
          ...
          const objects = [];
          Parser2.addObjectsRecursive(objects, page2, 0);
          for (const obj of objects) {
            doc._registerObject(obj, true);
          }
          for (const obj of objects) {
      ...
      *_iterPagesRecursively(doc, kids, filter, cursor) {
      ...
      async setAsTemplate(doc, firstPageOnly) {
        ...
        for (const page of this._iterPagesRecursively(doc, kids, filter)) {
          ...
          const objects = [];
          Parser2.addObjectsRecursive(objects, page, 0);
          for (const obj of objects) {
            doc._registerObject(obj, true);
          }
          for (const obj of objects) {
...
var require_package = __commonJS({
  "node_modules/pdfjs/package.json"(exports2, module) {
    module.exports = {
      name: "pdfjs",
...
var require_afm = __commonJS({
  "node_modules/pdfjs/lib/font/afm.js"(exports2, module) {
    "use strict";
    var PDFName = require_name();
    var PDFObject = require_object();
    var PDFString = require_string();
...
var require_footer = __commonJS({
  "node_modules/pdfjs/lib/footer.js"(exports2, module) {
    "use strict";
    var PDF = require_object2();
    var Header = require_header();
    module.exports = class Footer extends Header {
      ...
      async _pageBreak(level) {
        throw new Error(
          "Footer is to long (tried to execute a page break inside the footer)"
        );
      }
      async _start() {
...
var require_document = __commonJS({
  "node_modules/pdfjs/lib/document.js"(exports2, module) {
    "use strict";
    var Cursor = require_cursor();
    var Fragment = require_fragment();
    var ops = require_ops();
...
`;
        ...
        if (!Font2.isFont(this.defaultFont)) {
      ...
      async end() {
        ...
        this.info.creationDate = formatDate(
          ...
          this.info.creationDate || /* @__PURE__ */ new Date()
        );
        if (!this.info.producer) {
          this.info.producer = `pdfjs v${version2} (github.com/rkusa/pdfjs)`;
        }
...
var opentype_module_exports = {};
__export(opentype_module_exports, {
  BoundingBox: () => BoundingBox,
  Font: () => Font,
  Glyph: () => Glyph,
  Path: () => Path,
  _parse: () => parse2,
  default: () => opentype_module_default,
  load: () => load,
  loadSync: () => loadSync,
  parse: () => parseBuffer
});
...
var require_subset = __commonJS({
  "node_modules/pdfjs/lib/font/subset.js"(exports2, module) {
    "use strict";
    var opentype2 = (init_opentype_module(), __toCommonJS(opentype_module_exports));
...
var require_otf = __commonJS({
  "node_modules/pdfjs/lib/font/otf.js"(exports2, module) {
    "use strict";
    var opentype2 = (init_opentype_module(), __toCommonJS(opentype_module_exports));
...
var require_image = __commonJS({
  "node_modules/pdfjs/lib/image/image.js"(exports2, module) {
    var util = require_util();
    var PDFImage = require_pdf();
    var JPEGImage = require_jpeg();
...
var require_lib = __commonJS({
  "node_modules/pdfjs/lib/index.js"(exports2) {
    exports2.Document = require_document();
    exports2.Font = require_otf();
    exports2.Image = require_image();
    exports2.ExternalDocument = require_external();
